...
public class DomicilioServiceImpl implements DomicilioService {
    ...
    public DomicilioResponseDTO findById(Integer id) {
        return toResponse(getDomicilioOrThrow(id));
    }
    ...
    public DomicilioResponseDTO create(DomicilioRequestDTO dto) {
        Estado estado = estadoService.getEstadoOrThrow(dto.getIdEstado());
        Domicilio domicilio = new Domicilio();
        mapDtoToEntity(dto, domicilio, estado);
    ...
    private void mapDtoToEntity(DomicilioRequestDTO dto, Domicilio domicilio, Estado estado) {
