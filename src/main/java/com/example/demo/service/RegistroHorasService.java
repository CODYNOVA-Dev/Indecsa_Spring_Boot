...
public interface RegistroHorasService {
    RegistroHorasResponseDTO registrar(RegistroHorasRequestDTO dto, Integer idEmpleadoRegistro);
    ...
    RegistroHorasResponseDTO actualizar(Integer id, RegistroHorasRequestDTO dto);
